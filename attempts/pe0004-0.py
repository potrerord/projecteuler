...
##      Attempt #1: Testing all products of 3 digit numbers to see if they're palindromes
##      next try will prob be test all 5/6 digit palindromes to see if they are products of 3 digit numbers)
